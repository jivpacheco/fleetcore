...
// back/src/utils/cloudinary.js
// -----------------------------------------------------------------------------
// Configura y exporta la instancia de Cloudinary para uso global
// -----------------------------------------------------------------------------

import { v2 as cloudinary } from 'cloudinary';
import dotenv from 'dotenv';

// Cargar variables de entorno (asegúrate que server.js lo llame antes de cualquier import)
dotenv.config();
...
if (missing.length) {
  console.warn(`[cloudinary.js] ⚠️ Faltan variables de entorno: ${missing.join(', ')}`);
}
