...
// //v2
// // back/src/routes/people.routes.js
// import express from 'express';
// import { requireAuth } from '../middleware/requireAuth.js';
// import requirePermission from '../middleware/requirePermission.js';
// import { branchScope } from '../middleware/branchScope.js';
...
// // ====================== LICENSES (subdoc) ======================
// router.post('/:id/licenses',                 requireAuth, requirePermission('people:update'), branchScope, ensure(ctrl.addLicense, 'addLicense'));
// router.patch('/:id/licenses/:licenseId',     requireAuth, requirePermission('people:update'), branchScope, ensure(ctrl.updateLicense, 'updateLicense'));
// router.delete('/:id/licenses/:licenseId',    requireAuth, requirePermission('people:update'), branchScope, ensure(ctrl.removeLicense, 'removeLicense'));
...
// ====================== CRUD ======================
router.get('/',       requireAuth, requirePermission('people:read'),   branchScope, ensure(ctrl.list, 'list'));
router.get('/exists',  requireAuth, requirePermission('people:read'),   branchScope, ensure(ctrl.exists, 'exists'));
router.get('/:id',    requireAuth, requirePermission('people:read'),   branchScope, ensure(ctrl.get, 'get'));
router.post('/',      requireAuth, requirePermission('people:create'), branchScope, ensure(ctrl.create, 'create'));
router.patch('/:id',  requireAuth, requirePermission('people:update'), branchScope, ensure(ctrl.update, 'update'));
router.delete('/:id', requireAuth, requirePermission('people:delete'), branchScope, ensure(ctrl.remove, 'remove'));
