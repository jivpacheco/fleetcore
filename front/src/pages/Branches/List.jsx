  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Link
          className="w-full sm:w-auto text-center rounded-md text-white px-4 py-2"
          style={{ background: 'var(--fc-primary)' }}
          to="/branches/new"
        >
          Nueva sucursal
      ...
      {/* Filtros (simple) */}
      <div className="border rounded p-3 sm:p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        <input
