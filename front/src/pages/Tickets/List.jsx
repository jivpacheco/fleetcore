    ...
    <div>
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
        <div>
          ...
          <p className="text-gray-500 text-sm">Solicitudes (SRM)</p>
        </div>
        <div className="flex items-center gap-2">
          <input className="input border rounded px-3 py-2" placeholder="Buscar por código/vehículo"
            ...
            <tbody>
              ...
              {data?.docs?.map(t => (
                <tr key={t._id} className="border-t">
                  ...
                  <td className="px-4 py-2">{t.vehicleCode || t.vehicleId || '-'}</td>
