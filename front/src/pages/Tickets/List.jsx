// front/src/pages/Tickets/List.jsx
// -----------------------------------------------------------------------------
// Listado de Tickets (mismo patrón que Branches)
// -----------------------------------------------------------------------------
...
export default function TicketsList() {
  ...
  const { data, isLoading, error, refetch } = usePagedQuery(KEY, { page, limit, q }, TicketsAPI.list)
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
        <div>
          ...
          <p className="text-gray-500 text-sm">Solicitudes / incidencias</p>
        </div>
            ...
            <tbody>
              ...
              {data?.docs?.map((t) => (
                <tr key={t._id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2">{t.branchName || '-'}</td>
