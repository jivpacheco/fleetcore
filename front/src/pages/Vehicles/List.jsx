        ...
        <table className="min-w-full text-sm">
          ...
          <tbody>
            ...
            {items.map(v => {
              ...
              const inSupport = !!support.active
              // si está en apoyo: principal = originalInternalCode, badge = (replacementCode)
              const mainSigla = inSupport ? (support.originalInternalCode || v.internalCode) : (v.internalCode || '')
              const badge = inSupport ? (support.replacementCode || '') : ''
                ...
                <tr key={v._id} className="border-t">
                  <td className="p-2">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold">{mainSigla}</span>
                      {badge && (
...
// //***** actualizado - pdiente ver viavilidad */
// // front/src/pages/Vehicles/List.jsx
// // -----------------------------------------------------------------------------
// // Lista de Vehículos
