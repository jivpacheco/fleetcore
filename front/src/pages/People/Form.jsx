...
// actualizacion fallida de 220126+
// // // front/src/pages/People/Form.jsx
// // // -----------------------------------------------------------------------------
// // // RRHH - Ficha de Persona (Tabs)
// // // - Modo Ver: ?mode=view (bloquea inputs y muestra solo "Volver")
...
//               <label className="text-sm">
//                 <div className="text-gray-600 mb-1">Lugar de nacimiento</div>
//                 <input
...
//                 >
//                   <option value="">
//                     {form.addressRegion ? "Seleccione comuna..." : "Seleccione región primero"}
//                   </option>
//                   {comunas.map((c) => (
