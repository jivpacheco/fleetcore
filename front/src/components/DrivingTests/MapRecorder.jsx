 ...
 * Props:
 *  - onFinish({ startedAt, endedAt, durationSec, distanceKm, track, mapSnapshotDataUrl })
 *  - disabled: boolean (modo ver / sin permisos)
 */
export default function MapRecorder({ onFinish, disabled = false }) {
        ...
        <div className="border rounded p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
                <div className="text-sm">
                    Distancia: <b>{distanceKm}</b> km
                </div>
                <div className="text-sm">
                    Duración: <b>{durationSec}</b> s
                </div>
            </div>
            ...
            <div className="flex gap-2">
                <button
                    ...
                    title={readOnly ? "Modo visualización" : undefined}
                >
                    Iniciar
                </button>

                {/* finalizar y reiniciar aparecen solo después de iniciar */}
                {status !== "IDLE" && (
                    <>
                        {status === "RUNNING" && (
                            <button
            ...
            <div className="text-xs text-gray-600">Puntos registrados: {track.length}</div>
        </div>
    );
}